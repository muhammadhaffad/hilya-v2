@extends('v2.layouts.customer.app', ['title' => 'Pengaturan Akun | Hillia Collection', 'notfound' => false])
@section('content')
...
@endif
<div class="grid-cols-1 md:grid-cols-2 gap-4 grid w-full lg:w-8/12">
    <div class="w-full">
