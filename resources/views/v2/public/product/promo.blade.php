        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-6">
            ...
            <div class="flex flex-col gap-2 h-full">
                ...
                <div class="flex flex-col gap-4 h-full">
                    ...
                    <button class="px-5 w-full h-[42px] text-xs sm:text-base bg-color-4 text-white font-semibold uppercase border rounded" onclick="window.location.href='{{$promoProduct->link}}'">Lihat Produk</button>
                </div>
            </div>
            @empty
