...
Route::get('/username-check', [AuthenticationController::class, 'checkUsername'])->name('username.check');
Route::view('/register', 'v2.public.register')->name('register')->middleware('guest');
Route::view('/login', 'v2.public.login')->name('login')->middleware('guest');
Route::post('/register', [AuthenticationController::class, 'register'])->name('register.store')->middleware('guest');
Route::post('/login', [AuthenticationController::class, 'login'])->name('login.auth')->middleware('guest');
...
Route::get('/products/brands/{brand:slug}', [ProductController::class, 'brand'])->name('product.brand');
